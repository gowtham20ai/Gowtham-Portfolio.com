...
const MyProjects1 = ({image,title,description,t1,t2,t3,t4,site,github}) => {
    return (
        <>
            <div className="font-[Roboto] card-hover rounded-2xl border border-black border-spacing-50 hover:border-none text-white hover:text-black p-5 mt-10 space-y-2 shadow-md hover:shadow-3xl hover:translate-y-2 scale-in">
                <div className="">
                    <img
                        src={image}
                        alt="image"
                        className="rounded-lg mx-auto h-[180px] w-[400px] object-cover scale-in"
                    />
                </div>
                <div className="px-2">
                ...
                <div className="flex justify-between p-3 stagger-child">
