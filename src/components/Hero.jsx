    ...
    <>
      ...
      <div className="puff-in-center flex justify-around p-3 ml-5 mt-5 fade-in-up" id="Hero">
        <div className="w-fit ml-2 justify-center items-center stagger-child">
          ...
          <br />
          <p className="text-[22px] w-fit font-[Roboto] mt-5 bg-gradient-to-l from-blue-500 via-teal-500 to-green-500 text-transparent bg-clip-text md:w-[600px] lg:w-[600px] xl:w-[900px] 2xl:w-[1200px] fade-in-up">
        ...
        {/* image */}
        <div className="hidden lg:block mt-5 justify-end items-center overflow-hidden slide-in-left">
          <img
            src="https://ik.imagekit.io/8wxvbajv2/1766157556553.jpg"
            className="mt-10 w-[400px] rounded-br-[50px] scale-in"
          />
        </div>
      </div>
      {/* bttn */}
      <div className="mx-auto flex justify-start mt-4 ml-8 md:ml-24 lg:ml-15 mb-5 scale-in">
        <p className="vibrate-2 button-pulse py-2 px-4 bg-slate-500 w-fit bg-gradient-to-l from-blue-500 via-teal-500 to-green-500 font-[Roboto] rounded-2xl flex items-center gap-1 card-hover">
          {" "}
          View All
          <svg
